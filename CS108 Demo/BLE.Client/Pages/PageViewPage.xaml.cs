                    ...
                    case 1:
                        ...
                        if (BleMvxApplication._LargeContent.Length > 0) {
                            ...
                            for (int cnt = 0; cnt < BleMvxApplication._LargeContent.Length; cnt += lineLength) {
                                if (cnt + lineLength <= BleMvxApplication._LargeContent.Length) editorContent.Text += cnt.ToString() + " : "+ BleMvxApplication._LargeContent.Substring(cnt, lineLength);
                                else editorContent.Text += cnt.ToString() + " : " + BleMvxApplication._LargeContent.Substring(cnt, BleMvxApplication._LargeContent.Length - cnt);
