...
{
    public class ViewModelQTReadWritePrivateModeData : BaseViewModel
    {
        ...
        public ViewModelQTReadWritePrivateModeData(IAdapter adapter, IUserDialogs userDialogs) : base(adapter)
        {
