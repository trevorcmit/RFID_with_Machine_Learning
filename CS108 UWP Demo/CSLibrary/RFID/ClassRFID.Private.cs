    ...
    public partial class RFIDReader
    {
		...
		*/
        ...
        private Result MacReadOemData(UInt32 address, ref UInt32 value)
        {
            ...
            _deviceHandler.SendAsync(0, 0, DOWNLINKCMD.RFIDCMD, PacketData(0xf000, (UInt32)HST_CMD.RDOEM), HighLevelInterface.BTWAITCOMMANDRESPONSETYPE.WAIT_BTAPIRESPONSE_DATA1_COMMANDENDRESPONSE, (UInt32)CurrentOperation);
        ...
        private Result MacWriteOemData(uint address, uint value)
        {
            ...
            _deviceHandler.SendAsync(0, 0, DOWNLINKCMD.RFIDCMD, PacketData(0xf000, (UInt32)HST_CMD.WROEM), HighLevelInterface.BTWAITCOMMANDRESPONSETYPE.WAIT_BTAPIRESPONSE_COMMANDENDRESPONSE, (UInt32)CurrentOperation);
