        ...
        internal bool RecvNofigicationPacket(byte[] recvData)
        {
            ...
            switch (eventCode)
            {
                ...
                case 0xa101:        // Error Code
                    Debug.WriteLine("Error : CS108 Error Code : " + (UInt16)((UInt16)recvData[10] << 8 | (UInt16)recvData[11]));
                    //Trace.Message("Error : CS108 Error Code : {0}", (UInt16)((UInt16)recvData[10] << 8 | (UInt16)recvData[11]));
                    return false;
                    break;
