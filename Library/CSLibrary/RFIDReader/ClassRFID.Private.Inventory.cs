...
namespace CSLibrary {
    public partial class RFIDReader {
		...
		private void TagRangingThreadProc() {
			...
			Value &= 0xfff5fcff;
			if (m_rdr_opt_parms.TagRanging.multibanks != 0) Value |= (m_rdr_opt_parms.TagRanging.multibanks & (uint)0x03) << 16;

			if (m_rdr_opt_parms.TagRanging.QTMode == true) Value |= 0x00080000; // bit 19
